...
export default function Module1Timeline() {
  ...
  return (
    <section className="max-w-[1240px] mx-auto px-6 pt-14 flex flex-col gap-9">
      <TimelineRail
      ...
      <div className="grid gap-6.5" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))' }}>
        {activeHito?.quote ? (
